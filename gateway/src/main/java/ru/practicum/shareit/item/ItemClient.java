...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> updateItem(Integer itemId, Integer userId, ItemDto itemDto) {
    ...
    public ResponseEntity<Object> allPersonalItems(Integer userId, Integer from, Integer size) {
